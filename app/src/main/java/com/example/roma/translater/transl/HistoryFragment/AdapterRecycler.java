...
public class AdapterRecycler extends RecyclerView.Adapter<AdapterRecycler.HistoryChildRecycler> {
    ...
    Context context;
    HistoryFragmentContract.TranslateItemListener listener;

    boolean delete = false;


    public AdapterRecycler(HistoryFragmentContract.TranslateItemListener listener, List<TranslateItem> list, Context context) {
        listItems = list;
